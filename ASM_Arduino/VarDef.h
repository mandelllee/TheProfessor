...
#define Sens_ON         mcp.digitalWrite(5, LOW);
#define Sens_OFF        mcp.digitalWrite(5, HIGH);
#define LCD_ON          mcp.digitalWrite(6, LOW);
#define LCD_OFF         mcp.digitalWrite(6, HIGH);
